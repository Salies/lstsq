...
plt.scatter(np.vstack(x), y, facecolors='none', edgecolors='#00ff00', label='Pontos perturbados da função original')
plt.xlabel("x", fontsize=16)
plt.ylabel("y", fontsize=16)
plt.plot(np.vstack(x), f(x, theta['x']), label='Regressão não linear')
